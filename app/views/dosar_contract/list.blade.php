...
@section('title')
    Dosar
    @if ($contract !== null) 
      contract {{ $contract[0]->Numar }} din {{ $contract[0]->DataSemnarii }}
    @endif
@stop
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    ...
                    <div class="pull-right">                      
                        ...
                        <a href="{{ URL::route('document_upload', $contract[0]->IdContract) }}"><i class="fa fa-plus-circle fa-fw"></i> Nou</a>                      
                    </div>
               </div>
                          ...
                          @foreach ($documente as $key => $document)
                            <tr data-id="{{ $document->id_file }}">
                              ...
                              <td class="center action-buttons">
                                <a href="{{ URL::route('document_download', [$document->filename, $document->guid, $contract[0]->IdContract]) }}">
