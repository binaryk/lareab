    	...
    	@foreach($tip_contract as $tip_ctr)
    		...
    		<div class="panel panel-success" id="tip_ctr_{{ $tip_ctr->id }}" data-id="{{ $tip_ctr->id }}" data-table="tip_contract">
                <div class="panel-heading">
                    <span class="mev_pointer" onclick="show_hide_element(this, '.tip_contract_{{ $tip_ctr -> id }}');">
                    ...
                    <a class="pull-right" href="#" onclick="DeleteDateTemplate('tip_ctr_' + {{ $tip_ctr->id }}, '{{ URL::route('tip_contract_delete') }}', 'id')">
                    	<i class="fa fa-trash-o  fa-lg" title="Sterge"></i>
                    </a>
                    
                    <a href="#" onclick="GedIdTipContract('tip_ctr_' + {{ $tip_ctr->id }})" data-toggle="modal" data-target="#myModalTipActivitate" class="btn btn-success btn-xs add-level pull-right" title="Adauga tip activitate">Adauga tip activitate</a> <!-- Adauga tip activitate -->
                </div>
            </div>
            <!-- Sfarsit contract -->
            ...
            @foreach($tip_activitate as $tip_act)
            	@if($tip_act->id_tip_contract == $tip_ctr->id)	
                     <!-- Tip activitate -->                        
                    <div class="panel panel-warning tip_contract_{{ $tip_ctr -> id }} mev_hiden">
                        <div class="panel-heading">                            
                            <span class="mev_pointer" onclick="show_hide_element(this, '.tip_activitate_{{ $tip_act -> id}}');">
                            ...
                            <a class="pull-right" href="#" onclick="DeleteDateTemplate('tip_act_' + {{ $tip_act->id }}, '{{ URL::route('tip_activitate_delete') }}', 'id')">
                            	<i class="fa fa-trash-o  fa-lg" title="Sterge"></i>
                            </a>
                            
                            <a href="#" onclick="GetIdTipActivitate('tip_act_' + {{ $tip_act->id }}) "data-toggle="modal" data-target="#myModalTipActivitateTipizata" class="btn btn-warning btn-xs add-level" title="Adauga tip activitate tipizata">Adauga tip activitate tipizata</a> <!-- Adauga tip activitate tipizata -->
                        </div>
                    </div>
                    ...
                    @foreach($tip_activitate_tipizata as $tip_act_tip)
                    	@if($tip_act_tip->id_tip_activitate == $tip_act->id)                        
                            ...
                            <div class="panel panel-info tip_activitate_{{ $tip_act -> id}} mev_hiden" style="border-width:1px;">
                                <div class="panel-heading">                          
                                    <span class="mev_pointer" onclick="show_hide_element(this, '.tip_activitate_tipizata_{{ $tip_act_tip->id }}', 1);">
                                    ...
                                    <a style="float:right" href="#" onclick="DeleteDateTemplate('act_tip_' + {{ $tip_act_tip->id }}, '{{ URL::route('tip_activitate_tipizata_delete') }}', 'id')">
                                    	<i class="fa fa-trash-o fa-lg" title="Sterge"></i>
                                    </a>
                                </div>
                                             ...
                                             <table class="table table-striped table-hover table-bordered" style="text-align:left;">
                                                <thead>
                                                    <tr class="info">
                                                        <th>
                                                        	Denumire livrabil
                                                            <a href="#" onclick="GetIdTipActivitateTipizata('act_tip_' + {{ $tip_act_tip->id }}) "data-toggle="modal" data-target="#myModalTipLivrabile" class="btn btn-primary btn-xs" title="Adauga tip livrabil">
                                                            	Adauga
                                                            </a>
                                                        </th>
                                                ...
                                                <tbody>
                                                    @foreach($tip_livrabile as $tip_liv)
                                                        ...
                                                        <tr id="tip_liv_{{ $tip_liv->id }}" data-id="{{ $tip_liv->id }}" data-table="tip_livrabile">
                                                            ...
                                                            <td>
                                                            	<a href="#" onclick="DeleteDateTemplate('tip_liv_' + {{ $tip_liv->id }}, '{{ URL::route('tip_livrabile_delete') }}', 'id')">
                                                                	<i class="fa fa-trash-o fa-lg" title="Sterge"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                             ...
                                             <table class="table table-striped table-hover table-bordered" style="text-align:left;">
                                                <thead>
                                                    <tr class="info">
                                                        <th>
                                                        	Denumire
                                                            <a href="#" onclick="GetIdTipActivitateTipizata('act_tip_' + {{ $tip_act_tip->id }}) "data-toggle="modal" data-target="#myModalTipObligatiiSarcini" class="btn btn-primary btn-xs add-level" title="Adauga tip obligatii sarcini">
                                                            	Adauga
                                                            </a>                                                            
                                                        </th>
                                                        <th>Responsabil</th>
                                                ...
                                                <tbody>
                                                	@foreach($tip_obligatii_sarcini as $tip_ob_sar)
                                                        ...
                                                        <tr id="obl_sar_{{ $tip_ob_sar->id_tip_obligatie_sarcina }}" data-id="{{ $tip_ob_sar->id_tip_obligatie_sarcina }}" data-table="tip_obligatii_sarcini">
                                                            ...
                                                            <td>
                                                            	<a href="#" onclick="DeleteDateTemplate('obl_sar_' + {{ $tip_ob_sar->id_tip_obligatie_sarcina }}, '{{ URL::route('tip_obligatii_sarcini_delete') }}', 'id_tip_obligatie_sarcina')">
                                                                	<i class="fa fa-trash-o fa-lg" title="Sterge"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                ...
                                                <thead>
                                                    <tr class="info">
                                                        <th>
                                                            ...
                                                            <a href="#" onclick="GetIdTipActivitateTipizata('act_tip_' + {{ $tip_act_tip->id }}) "data-toggle="modal" data-target="#myModalResponsabilitateActTip" class="btn btn-primary btn-xs add-level" title="Adauga responsabilitate tipizata">
                                                            	Adauga
                                                            </a>
                                                        </th>
                                                        <th class="min_width center">Actiuni</th>
                                                    ...
                                                    @foreach($responsabilitate_act_tip as $resp_act_tip)
                                                        @if($resp_act_tip->id_activitate_tipizata == $tip_act_tip->id)
                                                            <tr id="res_act_{{ $resp_act_tip->id_resp_at }}" data-id="{{ $resp_act_tip->id_resp_at }}" data-table="responsabilitate_act_tip">
                                                                ...
                                                                <td>
                                                                    <div align="center">
                                                                        <a href="#" onclick="DeleteDateTemplate('res_act_' + {{ $resp_act_tip->id_resp_at }}, '{{ URL::route('responsabilitate_act_tip_delete') }}', 'id_resp_at')">
                                                                        	<i class="fa fa-trash-o fa-lg" title="Sterge"></i>
                                                                        </a>
                                                                    </div>
                                                                </td>
