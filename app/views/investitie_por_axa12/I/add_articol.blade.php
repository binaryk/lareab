...
@section('title')
    Adauga articol de deviz la obiect @if (isset($obiect)) "{{ $obiect }}" @endif
@stop
        ...
        <div class="col-lg-12">
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
                    ...
                    <div class="col-md-6">
                        {{ Form::selectField('Destinatie spatiu', 'destinatie_spatiu', $destinatie_spatiu) }}                    
                    </div>                                 
                    
                    <div class="col-md-6">
                        {{ Form::selectField('Tip lucrari', 'tip_lucrari', $tip_lucrari) }}                    
                    </div>
                    ...
                    <div class="form-group col-lg-12                   
                        ...
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('esl', '0', Input::old('esl', '')) }}
                    ...
                    <div class="form-group col-lg-12                   
                        ...
                        @endif">
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('esl', '0', Input::old('nesl', '')) }}
                    ...
                    <div class="form-group col-lg-12                   
                        ...
                        @endif">
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('nsad', '0', Input::old('nsad', '')) }}
                    ...
                    <div class="form-group col-lg-12                   
                        ...
                        @endif">
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('esad', '0', Input::old('esad', '')) }}
