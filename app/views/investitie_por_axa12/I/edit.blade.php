...
@section('title')
    Modifica obiect investitie @if (isset($obiect->investitie)) {{ $obiect->investitie }} @endif
@stop
        ...
        <div class="col-lg-12">
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
                    ...
                    <div class="col-md-12">
                        {{ Form::textField('Denumire obiect', 'denumire', $obiect->denumire) }}                    
                    </div>                                                         
                    ...
                    <div class="col-md-12 center"> 
                        ...
                        <a href="{{ URL::route('investitie_por_axa12_obiecte_list', $obiect->id_investitie) }}">
