    ...
    <div class="row">
        <div class="col-lg-12">
                                  ...
                                  @foreach ($imobile as $imobil)
                                    <tr data-id="{{ $imobil->id }}">                              
                                      ...
                                      <td class="center action-buttons">           
                                        <a href="#"><i class="fa fa-hand-o-down" title="Sterge"></i></a>
                                      </td>                                  
                                    </tr>
                                  @endforeach                              
                                </tbody>
            ...
            <div class="panel panel-info">
                ...
                <div id="div_tip_cheltuieli" class="panel-body panel-info" style="display:none">                    
                   <div class="panel-body">
                       <div class="table-responsive">
                          <table class="table table-striped table-bordered table-hover" id="dataTables-imobil">
                            <thead>
            ...
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
                    ...
                    @endif                     
                    <div class="hidden">                    
                        {{ Form::textField('ID Imobil', 'id_imobil', $investitie->id_imobil) }}                                 
                    </div>

                    <div class="col-md-4">
                        {{ Form::textField('Adresa imobil', 'imobil', $investitie->adresa, ['readonly']) }}                    
                    </div>                
                                                                                                        
                    <div class="col-md-4">
                        {{ Form::textField('Judet', 'judet', $investitie->judet, ['readonly']) }}                    
                    </div>

                    <div class="col-md-4">
                        {{ Form::textField('Localitate', 'localitate', $investitie->localitate, ['readonly']) }}
                    </div> 

                    <div class="col-md-12">
                        {{ Form::selectField('Al carui departament este investitia?', 'departament', $departamente, $investitie->id_departament) }}                    
                    </div> 

                    <div class="col-md-8">
                        {{ Form::textField('Denumire investitie', 'denumire', $investitie->denumire) }}
                    </div>

                    <div class="col-md-4">
                        {{ Form::selectField('Cota TVA', 'cota_tva', $tva, $investitie->id_tva) }}                    
                    </div> 

                    <div class="col-md-4">
                        {{ Form::textNumericField('1) Cota indiviza spatii de locuit (%)', 'cota_indiviza_spatii_locuit', $investitie->cota_indiviza_spatii_locuit) }}
                    </div>       

                    <div class="col-md-4">
                        {{ Form::textNumericField('2) Cota indiviza spatii alta destinatie (%)', 'cota_indiviza_spatii_alta_destinatie', $investitie->cota_indiviza_spatii_alta_destinatie) }}
                    </div>       
                    ...
                    <div class="col-md-4">
                        {{ Form::textNumericField('4) Finantare nerambursabila POR (%)', 'finantare_nerambursabila_por', $investitie->finantare_nerambursabila_por, ['readonly']) }}                    
                    </div>       

                    <div class="col-md-4">
                        {{ Form::textNumericField('5) Cofinantare AP cheltuieli eligibile (%)', 'cofinantare_ap_eligibil', $investitie->cofinantare_ap_eligibil) }}                    
                    </div>

                    <div class="col-md-4">
                        {{ Form::textNumericField('6) Cofinantare UAT cheltuieli eligibile (%)', 'cofinantare_uat_eligibil', $investitie->cofinantare_uat_eligibil, ['readonly']) }}                    
                    </div>

                    <div class="col-md-4">
                        {{ Form::textNumericField('7) Cofinantare AP cheltuieli neeligibile (spatii alta destinatie) (%)', 'cofinantare_ap_neeligibil_ad', $investitie->cofinantare_ap_neeligibil_ad, ['readonly']) }}                        
                    </div>       
                    
                    <div class="col-md-4">
                        {{ Form::textNumericField('8) Cofinantare UAT cheltuieli neeligibile (%)', 'cofinantare_uat_neeligibil', $investitie->cofinantare_uat_neeligibil) }}                    
                    </div>       

                    <div class="col-md-4">
                        {{ Form::textNumericField('9) Cofinantare AP cheltuieli neeligibile (spatiil de locuit) (%)', 'cofinantare_ap_neeligibil_sl', $investitie->cofinantare_ap_neeligibil_sl, ['readonly']) }}                        
                    </div>                   
...
@section('footer_scripts')
    ...
    <script>
        ...
        $(document).ready(function(){ 
            ...
            function calculeazaCotaIndiviza()
            {
