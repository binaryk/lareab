...
@section('title')
    <p>Modifica date client 
        @if(isset($client->denumire)) {{ $client->denumire }} @endif
    </p>
@stop
            ...
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
                    ...
                    <div class="form-group col-lg-6                   
                        ...
                        <input class="form-control" name="num_ord_rc" type="text"
                        @if(Input::old('num_ord_rc')) 
                            value="{{ Input::old('num_ord_rc') }}" 
                        @else 
                            value="{{ $client->norc }}" 
                        @endif 
                    ...
                    <div class="form-group col-lg-4
                        ...
                        <select 
                            ...
                            @else 
                                value="{{ $client->id_regiune }}" 
                            @endif>{{ $client->regiune }}
                            </option>                                    
                        </select>        
                    </div>
                    ...
                    <div class="form-group col-lg-12
                        ...
                        <select 
                            ...
                            @else 
                                value="{{ $client->id_localitate }}" 
                            @endif>{{ $client->localitate }}
                            </option>                                              
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('servicii', '1', Input::old('servicii', $client->servicii)) }}
                    ...
                    <div class="form-group col-lg-4">
                        <div class="checkbox checkbox-primary">
                             {{ Form::checkbox('lucrari', '1', Input::old('lucrari', $client->lucrari)) }}
                    ...
                    <div class="form-group col-lg-4">                       
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('furnizare', '1', Input::old('furnizare', $client->furnizare)) }}
                    ...
                    <div class="form-group col-lg-4"> 
                        <input type="submit" name="submit" 
                            class="btn btn-primary btn-lg" value="Salveaza"/>                                        
                    </div>
                    {{ Form::token() }}
                </fieldset>
            </form>
