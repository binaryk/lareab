                ...
                <fieldset>
                    ...
                    <div class="form-group col-lg-12
                        ...
                        <select 
                            ...
                            @else 
                                value="{{ $firma->id_localitate }}" 
                            @endif>{{ $firma->localitate }}
                            </option>                                              
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('servicii', '1', Input::old('servicii', $firma->servicii)) }}
                    ...
                    <div class="form-group col-lg-4">
                        <div class="checkbox checkbox-primary">
                             {{ Form::checkbox('lucrari', '1', Input::old('lucrari', $firma->lucrari)) }}
                    ...
                    <div class="form-group col-lg-4">                       
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('furnizare', '1', Input::old('furnizare', $firma->furnizare)) }}
