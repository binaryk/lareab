        ...
        <div class="col-lg-12">
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
					...
					<div class="col-md-4">
						{{ Form::textField('Nume proprietar', 'nume') }}
					</div>
					...
					<div class="col-md-4">
						{{ Form::textField('Etaj', 'etaj') }}
					</div>	
					
					<div class="col-md-4">  
						{{ Form::textNumericField('Suprafata utila (&#13217;)', 'suprafata_utila', Input::old('suprafata_utila', isset($entry_form) ? $entry_form['suprafata_utila'] : null)) }}
					</div>

					<div class="col-md-4">  
						{{ Form::textField('Numar membri familie', 'nr_membri') }}
					</div>

					<div class="col-md-4">						
						{{ Form::selectField('Destinatie locuinta', 'dest_sp', $dest_sp, null, []) }}					
					</div>	

					<div class="col-md-4">
						{{ Session::put('callback', URL::route('locatar_add', $id_imobil)) }}					
						{{ Form::selectField('Scara', 'scara', ['' => 'Selectioneaza scara'] + $scari, null, [], 'fa fa-plus-circle fa-fw', URL::route('scara_add', $id_imobil)) }}					
					</div>	
			        
					<div class="col-md-4">
						{{ Form::selectField('Acord locatar *', 'acord_locatar', $acord_locatar) }}					
					</div>	

					<div class="col-md-4">
						{{ Form::selectField('Venit lunar locatar **', 'venit_lunar_locatar', $venit_lunar_locatar) }}					
					</div>	
	                ...
	                <div class="form-group col-lg-12                   
                        ...
                        <div class="checkbox checkbox-primary">
                            {{ Form::checkbox('asteapta_verificare', '1', Input::old('asteapta_verificare', '')) }}
