           ...
           <div class="panel panel-primary">
                ...
                <div id="div_cautare" class="panel-body" style="display:none">
                    <table width="100%">
                        ...
                        <tr>
                            <td width="25%">
                                <label class="control-label">%Cota parte introdusa</label></td>
                            <td width="75%"><p id="_col_cota_parte_introdusa"></p></td>
                        </tr>                                                          
                        <tr>
                            <td width="25%">
                                <label class="control-label">%Cota parte calculata</label></td>
                            <td width="75%"><p id="_col_cota_parte_calculata"></p></td>
                        </tr>                                                          
                        <tr>
                            <td width="25%">
            ...
            <div class="panel panel-default">
                      ...
                      <table class="table table-striped table-bordered table-hover" id="dataTables-locatari">
                        <thead>
                          <tr>                                                             
                            ...
                            <th class="text-center">Cota parte introdusa</th>
                            <th class="text-center">Cota parte calculata</th>
                        ...
                        <tbody>                             
                          @foreach ($locatari as $locatar)
                            <tr data-id="{{ $locatar->id }}">                                                            
                              ...
                              <td class="hidden">
                                {{ $cota_parte_sumata += $locatar->cota_parte }}
               ...
               <div class ='alert alert-info alert-dismissable'>
                    <table class="table">
                        ...
                        <tr>
                            <td>{{ Form::label('', 'Total cotă parte imobil calculata in baza suprafetei utile(&#37;) =') }}</td>
                            <td class="text-right">{{ Form::label('', number_format($cota_parte_calculata, 2, ',', '.')) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>{{ Form::label('', 'Total cotă parte imobil introdusa (&#37;) =') }}</td>
                            <td class="text-right">{{ Form::label('', number_format($cota_parte_sumata, 2, ',', '.')) }}</td>
                            <td class="text-right">
                                @if ((BaseController::numere_aproape_egale(100, $cota_parte_calculata) && (0 == $cota_parte_sumata)) || ((0 == $cota_parte_calculata) && BaseController::numere_aproape_egale(100, $cota_parte_sumata)))                                 
                                @else
                                    <button type="button" class="btn btn-danger dim" id="btn_cota_indiviza_error"><i class="fa fa-warning"></i></button>
                                @endif
                            </td>
                        </tr>                        
                        <tr>
...
@section('footer_scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn_cota_indiviza_error').on('click', function(){
                MessageBox("ERROR", "Eroare de calcul cota indiviza. Total cota indiviza calculata trebuie sa fie 100% cand total cota indiviza introdusa este 0% si invers.");
            });
            ...
            $('#dataTables-locatari').dataTable().columnFilter({
              aoColumns: [ 
                  ...
                  { sSelector: "#_col_cota_parte_introdusa", type: "text" },
                  { sSelector: "#_col_cota_parte_calculata", type: "text" },
