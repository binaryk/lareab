            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                  ...
                  <div class="pull-right">                      
                      ...
                      <a href="{{ URL::route('banca_entitate_add', [$id_entitate, $entitate]) }}">
                          ...
                          @foreach ($banci_entitate as $banca)
                            <tr data-id="{{ $banca->id }}">         
                              ...
                              <td class="center action-buttons">                                
                                <a href="{{ URL::route('banca_entitate_edit', [$banca->id, $id_entitate, $entitate]) }}"><i class="fa fa-pencil-square-o" title="Editeaza"></i></a>
