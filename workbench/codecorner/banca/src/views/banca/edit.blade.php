        ...
        <div class="col-lg-12">
            <form role="form" action="{{ URL::current() }}" method="post">
                <fieldset>
                    ...
                    @endif                  
                    <div class="col-md-6">
                        {{ Form::textField('Denumire', 'denumire', $banca->denumire) }}                    
                    </div>

                    <div class="col-md-6">
                        {{ Form::textField('Telefon', 'telefon', $banca->telefon) }}                    
                    </div>

                    <div class="col-md-12">
                        {{ Form::textField('Adresa', 'adresa', $banca->adresa) }}                    
                    </div>                    
